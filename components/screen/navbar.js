	...
	render() {
		return (
			<div className="main-navbar-vp absolute top-0 right-0 w-screen shadow-md flex flex-nowrap justify-between items-center bg-ub-grey text-ubt-grey text-sm select-none z-50">
				...
				<button
					onClick={this.props.toggleRecruiterMode}
					className="hidden md:flex items-center gap-1 mx-2 bg-ub-orange text-white px-2 py-0.5 rounded text-xs hover:bg-red-600 transition"
				>
					<span className='font-bold'>Recruiter Mode</span>
				</button>
				<div
					id="status-bar"
					tabIndex="0"
